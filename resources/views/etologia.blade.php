      ...
      <div class="col" max-width: 50%;>
        <center>
          <div class="box">
            ...
            <h5>
              <p align="justify">
                Si crees que tu mascota no se comporta de la mejor manera y observas que tiene conductas extrañas;
                Caniscatus ofrece un profesional especialista, quien evaluara a tu mascota a través de un examen
                comportamental, emitiendo un diagnóstico y posteriormente tratamiento requerido según la conducta
                presentada.
          </div>
      </div>
    </div>
